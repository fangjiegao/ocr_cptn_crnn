...
import crnn.nets.cnn.resnet_utils as resnet_utils
            ...
            with slim.arg_scope([slim.batch_norm], is_training=is_training):
                ...
                if include_root_block:
                    ...
                    with slim.arg_scope([slim.conv2d],
                        ...
                        # Changed by sanster: kernel_size 7 -> 3, stride 2->1
                        net = resnet_utils.conv2d_same(net, 64, 3, stride=1, scope='conv1')
                    # Changed by sanster: kernel_size 3 -> 2, stride [2, 2] -> [2, 1]
                    net = slim.max_pool2d(net, [2, 2], stride=[2, 1], scope='pool1')
...
class ResNetV2(object):
    def __init__(self, inputs, is_training):
        ...
        blocks = [
            ...
            resnet_v2_block('block4', base_depth=256, num_units=2, stride=1),
        ]

        self.net, self.end_points = resnet_v2(inputs, blocks, is_training=is_training,
...
if __name__ == '__main__':
    ...
    res_net = ResNetV2(inputs, is_training)
