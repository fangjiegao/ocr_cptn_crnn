# -*- coding:utf-8 -*-
import numpy as np
from ctpn.bbox.nms import nms

from ctpn.bbox.bbox_transform import bbox_transform_inv, clip_boxes
...
# rpn_cls_prob_reshape:预测的文本位置, cls_prob_val:是文本的概率, im_info:图像的shape
